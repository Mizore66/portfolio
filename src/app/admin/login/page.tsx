    ...
    <main className="px-4 py-8 sm:px-6">
      ...
      <h1 className="mt-2 font-display text-[28px] leading-tight text-ink">Sign in</h1>
        <p className="mt-3 max-w-[48ch] font-display text-[16px] text-ink">
          One owner. No public registration. Recovery is rotating ADMIN_PASSWORD_HASH, which invalidates every
          session. MFA is an optional authenticator code when ADMIN_TOTP_SECRET is set.
        </p>
      {ready ? (

...
export const BROADSHEET = {
  ...
  readHintDesktop: "Click any move. When the board has focus, ← → steps the mainline. Tab to the board, or skip the diagram and read the scoresheet.",
  ...
  paperLinkDek: "the annotated career, as a chess game",
  teaserLine: "1. e4 e5  2. Nf3 Nc6  3. Bc4 Bc5  4. O-O Nf6  5. d4",
  teaserDek: "A playable career timeline told through an Italian Game. The full scoresheet lives on its own plate.",
  ...
  boardKeys: "Tab to the board, then ← → steps the scoresheet. Chevrons under the diagram do the same.",
  ...
  correctionDek: "It never made the plate. The front page still holds the work.",
  exhibitHost: "No live host. The case study on this page is the remaining public artifact.",
  exhibitGithub:
    "If GitHub is blocked on this network, the apparatus and the line above are the argument.",
  homeLink: "Back to the front page",
...
export const OPENING_NODES: OpeningNode[] = [
  {
    ...
    commentary:
      "The scoresheet is the only place the line is playable. What follows is the game I actually played — jobs as moves, annotations as voice. Chess is the content, never the lock.",
    eval: 0.2,
    evalText: "+0.2",
    artifacts: [],
    plies: [],
  ...
  },
  {
    ...
    fact: `${lead.name} — ${lead.subtitle}. PySpark over ${METRICS.leadThroughput.display}, Deep Interest Network on PyTorch DDP, checkpointed so a failed hour resumes from the last completed slice.`,
    commentary:
  ...
  },
  {
    ...
    fact: `Western Digital — Full-stack Engineer, Feb 2025 – Dec 2025. Lab-operations dashboard; role-based access for 50+ staff, ${METRICS.wdOversight.display} (${METRICS.wdOversight.oversight}). ${METRICS.wdOversight.socket}; ${METRICS.wdOversight.latency}. Concurrent with the Setel internship from July.`,
    commentary:

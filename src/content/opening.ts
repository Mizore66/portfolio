...
export const BROADSHEET = {
  ...
  engineBadge: "ENGINE · 2200-anchored · −100 self-play",
  ...
  evaluationsHed: "LEARNED FALLS TO HANDCRAFTED BY −100 ELO",
  evaluationsDek:
    "Two evals, one search. Handcrafted PeSTO against a 768×2×128 net trained on 6 million quiet Lichess cloud evals (CC0). The net is a residual on classical material; capture chains stay with PeSTO. Fixed 1 000 nodes a move (the spec default is 50 000 — this first column is the shorter count), the same fifty openings, colours swapped. 5 wins, 62 draws, 33 losses. The delta is the measurement; the 2200 on the glass is a club-strength anchor, not a CCRL listing.",
  evaluationsSprt: "sprt: −100.0 ±35.4 Elo, 100 games, LLR −1.69 (inconclusive)",
  evaluationsHonesty: "Honest Elo: the deltas are rigorous, the anchor is declared. A loss is still a result.",
  eloChartKicker: "Elo over commits",
  eloChartCaption: "Each point is a match JSON. Gate A sits at 0. Gate C is the first learned point — below the axis.",
  eloCommits: [
    { commit: "a718d47", label: "A · PeSTO", elo: 0, games: 16 },
    { commit: "gate-c", label: "C · learned", elo: -100, games: 100 },

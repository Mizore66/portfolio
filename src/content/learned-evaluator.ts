...
export const LAB_ARTICLE = {
  ...
  dek: "N = 128 games. SPRT terminated for H0. The training data was the bottleneck.",
  ...
  learnedHed: "This net is closed; the bottleneck is still the data",
  learned:
    "A loss at the spec cap is still a result. Do not compare Gate C at 50 000 nodes with the earlier −100 at 1 000 nodes — that was the v1 128. The 2200 on the glass is a club-strength anchor, not a CCRL listing. Do not rematch this net. A new net still has to pass the GUARDS.md data and progress gates first.",
} as const;

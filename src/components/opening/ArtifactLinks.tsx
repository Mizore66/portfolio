  ...
  return (
    <ul className="flex flex-wrap gap-x-4 gap-y-2 font-mono text-[12px] uppercase tracking-wider">
      {artifacts.map((a) => {
        ...
        const className =
          "artifact-link text-book-blue underline decoration-2 underline-offset-4 focus-visible:outline-2 focus-visible:outline-ink focus-visible:outline-offset-2";
        return (
